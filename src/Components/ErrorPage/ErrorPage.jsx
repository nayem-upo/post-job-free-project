  ...
  return (
    <div className=" mb-20">
      <img
        ...
        src="public/assets/All Images/Vector-1.png"
        alt=""
      />
      <div
        style={{
      ...
      >
        ...
        <Link
          to="/"
          className="text-[#7E90FE] hover:text-white hover:bg-[#7E90FE] shadow-lg text-lg font-semibold border-2 p-2 border-[#7E90FE] rounded-md"
        >
