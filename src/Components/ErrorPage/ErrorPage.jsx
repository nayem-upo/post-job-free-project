  ...
  return (
    <div className=" mb-20">
      <div  style={{
        ...
        <Link to="/" className="text-[#7E90FE] hover:text-white hover:bg-[#7E90FE] shadow-lg text-lg font-semibold border-2 p-2 border-[#7E90FE] rounded-md">Go back to the homepage</Link>
      </div>
    </div>
  );
};
