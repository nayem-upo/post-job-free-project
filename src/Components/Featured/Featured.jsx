...
const Featured = () => {
  ...
  return (
    <div className="mt-32 text-center md:w-[1150px] mx-auto mb-20">
      ...
      <p className="text-[#8E8E8E] py-8 text-lg">
      ...
      <div className="grid mx-auto w-[90%] md:w-[100%] md:grid-cols-2 gap-7 md:gap-4 mb-10 md:justify-evenly">
        {lessItems.map((item) => (
          <div
            key={item.id}
            className="border flex flex-col md:justify-between justify-center rounded-lg md:p-9 p-5 text-left shadow-md"
          >
            <img className="w-36 pb-8" src={item.logo} alt="" />
            <h1 className="font-bold text-2xl text-[#474747]">
              {item.job_title}
            </h1>
            <p className="font-semibold my-4 text-xl text-[#757575]">
              {item.company_name}
            </p>
            ...
            <button
              ...
              className="md:w-[35%] bg-gradient-to-l from-[#8786FE] via-purple-500 to-purple-400 py-2 px-4 text-white font-semibold text-2xl rounded hover:bg-[#9774FF] hover:text-[#87A2FE]"
            >
              View Details
            </button>
          </div>
      ...
      <button
        ...
        className={`${
          number > 4 ? "hidden" : ""
        } bg- bg-gradient-to-l from-[#8786FE] via-purple-500 to-purple-400 py-4 px-6 text-white font-semibold text-2xl rounded-lg hover:bg-[#9774FF] hover:text-[#87A2FE]`}
      >
        See All Jobs
      </button>
    </div>
